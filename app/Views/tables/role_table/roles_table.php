  ...
  <div class="container-fluid" style="padding:20px;">
                    ...
                    <div class="row">
                        ...
                        <div style="margin-bottom:5px;">
                                ...
                                <form method="get" style="width:100%;" action="<?= base_url('/dashboard/role/add_role') ?>">
                                    <button type="submit" style="width:100%;" class="btn  btn-success ">CREATE ROLE</button>
                                </form>
                                ...
                                <?php foreach ($roles as $role): ?> 
                                        ...
                                        <td style="width:10%;">
                                            <div style="display:inline-flex; width:100%;">
                                                        ...
                                                        <form method="get" style="width:100%;" action="<?= base_url('/dashboard/role/edit/'.$role['id']) ?>">
                                                            <button type="submit" class="btn  btn-primary deletebtn">EDIT</button>
                                                        </form>  
                                                

                                                        <form method="POST" action="<?= base_url('/dashboard/role/delete/'.$role['id']) ?>">
                                                            <?= csrf_field() ?>   

...
<?= $this->section('content') ?>
    ...
    <form id="reg_form" method="POST" action="<?= base_url('/dashboard/head_department/store') ?>">
        <?= csrf_field() ?>
        ...
        <div class="form-group" style="width: 100%;">
            ...
            <input type="submit" style="text-transform:uppercase;" value="Create Head Department">
